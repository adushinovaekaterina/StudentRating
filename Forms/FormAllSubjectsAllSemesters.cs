...
namespace StudentRating.Forms
{
    public partial class FormAllSubjectsAllSemesters : Form
    {
        ...
        private void RefreshDataGridView(DataGridView dataGridView)
        {
            ...
            SqlCommand sqlCommandGetStudentsGrades = new SqlCommand(queryStringGetStudentsGrades, sqlConnection);
            ...
            SqlCommand sqlCommandGetGroupName = new SqlCommand(queryStringGetGroupName, sqlConnection);
